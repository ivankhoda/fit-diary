...
ActiveRecord::Schema[7.0].define(version: 2023_12_27_140932) do
  ...
  create_table "user_exercise_sets", force: :cascade do |t|
    t.bigint "user_exercise_id"
    t.integer "repetitions"
    t.integer "weight"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_exercise_id"], name: "index_user_exercise_sets_on_user_exercise_id"
  end
  ...
  create_table "user_exercises", force: :cascade do |t|
    ...
    t.index ["telegram_user_id"], name: "index_user_exercises_on_telegram_user_id"
  ...
  create_table "user_workouts", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "state"
    t.index ["telegram_user_id"], name: "index_user_workouts_on_telegram_user_id"
  ...
  create_table "workouts", force: :cascade do |t|
    ...
    t.datetime "started_at"
    t.datetime "finished_at"
    t.bigint "workout_exercises_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["workout_exercises_id"], name: "index_workouts_on_workout_exercises_id"
  end
